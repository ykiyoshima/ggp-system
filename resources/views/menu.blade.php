...
<body>
    <h1 class="text-6xl text-gray-900 font-bold text-center py-32">MENU</h1>
    <a id="review_btn" href="/review" class="block w-64 py-4 mb-24 mx-auto rounded text-2xl text-center bg-gray-300 text-gray-900 hover:bg-gray-500 hover:text-gray-100">審査に参加</a>
